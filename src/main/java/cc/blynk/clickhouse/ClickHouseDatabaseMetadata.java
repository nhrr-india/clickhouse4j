...
public final class ClickHouseDatabaseMetadata implements DatabaseMetaData {
    ...
    public ResultSet getTables(String catalog,
        ...
        while (result.next()) {
            ...
            /*
             Changes for Dremio
             Changes done based on the reference from https://community.dremio.com/t/incorrect-datasource-schema-generated/4906 regarding incorrect datasource schema generated by Dremio.
             ClickHouse has only one level of namespace (the database name), schema in Dremio is generated with multiple levels (“default” folder / database folders / tables).
             So Dremio generates the query request "select * from “default”.“database”.“table” instead of "select * from “database”.“table” which causes query to fail.
             */
            row.add(null);
            // row.add(DEFAULT_CAT);
            /*
